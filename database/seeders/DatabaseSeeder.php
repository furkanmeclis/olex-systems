...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $usersNotFound = User::whereIn('email',['furkanmeclis@icloud.com','huseyinulkenn@gmail.com','suleymanipek@gmail.com','olex@gmail.com'])->count();
        if($usersNotFound === 0){
