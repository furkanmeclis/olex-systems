...
class GenerateCarSvg
{
    ...
    {
        $this->svgCarPath = storage_path('app/public/olex_car_template.svg');
        $this->svgContent = file_get_contents($this->svgCarPath);
    }

    public function getActiveColor($partName):string
    {
        return $this->activeColors[$partName];
    }

    public function generateFile(): \Illuminate\Foundation\Application|string|\Illuminate\Contracts\Routing\UrlGenerator
    {
