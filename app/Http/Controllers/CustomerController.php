        ...
        try {
            ...
            if ($customer) {
                ...
                if ($action == "token") {
                    ...
                    if ($customer->save()) {
                        $notify = new \App\Notifications\FirebaseNotification(env("APP_NAME"), "Bildirimler Başarıyla Aktif Hale Getirildi.", $customer->player_id, route('customer.notify', ['hash' => encrypt($customer->id)]));
