        ...
        <>
            ...
            >
                <motion.div
                    ...
                    className={classNames("bg-gradient-to-b from-[#2e2f31] cursor-pointer to-[#1a1b1d] rounded-xl border border-[#373739] overflow-hidden mb-2", {
                        "hidden": isSkeleton
                    })}
