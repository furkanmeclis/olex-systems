...
const WarrantyIndex = ({serviceNumber,csrf_token}) => {
    ...
    const Content = ({mobile= false}) => {
        return serviceData?.brand_logo ? <div className={"bg-gradient-to-b  pt-10 h-full from-[#008951] to-[#003d24] "+(mobile && " pb-10 pt-15")}>
            ...
            <div className={"w-full flex justify-center items-center mt-8 "}>
                <span className={"font-thin text-[12px]"}><b className={"font-bold text-white"}>OLEX Films &copy;</b> <span className={"text-gray-200 dark:text-gray-400"}>{new Date().getFullYear()} All Rights Reserved.</span></span>
            </div>
        </div> : <></>;
    }
