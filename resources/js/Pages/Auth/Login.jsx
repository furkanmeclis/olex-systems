                                    ...
                                    <label className="flex items-center space-x-2 cursor-pointer group">
                                        <div className="relative">
                                            <Field
                                                ...
                                                className="hidden"
                                            />
                                            <div className={`w-5 h-5 border-2 rounded-md transition-all duration-300 ${values.remember ? 'bg-green-500 border-green-500' : 'border-green-500 group-hover:border-green-400'}`}>
                                                {values.remember && <i className="pi pi-check text-white text-xs absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></i>}
                                            </div>
                                        </div>
