...
const Profile = ({dealer, detail, csrf_token, toast, setLoading, loading, setDetail,superPage=true}) => {
    const fileInput = useRef(null);
    const [file, setFile] = useState(false);
    const [activeIndex, setActiveIndex] = useSessionStorage(0, `${superPage === true?"super":"dealer"}-profile-tab-index`);
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        fetch(route(`${superPage === true?"super":"dealer"}.dealers.updateDetails`, dealer.id), {
            method: 'POST',
            headers: {
