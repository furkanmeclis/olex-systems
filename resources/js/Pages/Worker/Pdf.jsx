...
const useServiceTemplate = (data = {}, options = {}) => {
    ...
    const handlePrint = useReactToPrint({
        ...
        onBeforePrint: () => {
            toast.current.show({
                severity: 'warn',
                summary: 'Yazdırma Başlatıldı',
                detail: 'Belge yazdırılıyor...',
        ...
        onAfterPrint: () => {
            ...
            toast.current.show({
                severity: 'success',
                summary: 'Yazdırma Başarılı',
                detail: 'Belge yazdırma ekranı açıldı.',
    ...
    const ServiceTemplate = (props) => {
        const items = [
            {
                ...
                command: () => {
                    setImageMode(true);
                    html2canvas(savelableRef.current, {
        ...
        return <>
            ...
            {hidden === false && data?.brand_logo &&
                <div className={"servicePdf"} onContextMenu={(e) => ref2.current.show(e)} ref={ref}>
                    <div className="page4">
                                        ...
                                        <td>
                                            <div className={"tdWrapper"}>
                                                ...
                                                <div className="warranty">
                                                    {service.warranty} <span className="icon"><svg fill="none"
                                                                                                   height="32"
                                                                                                   viewBox="0 0 32 32"
                                                                                                   width="32"
                    ...
                    <div className={"page3"}>
                        ...
                        <p className={"description"}><b>İlk 7 Gün:</b> Araç Yıkama : Uygulamadan sonraki ilk 7 gün
                            boyunca aracınızı
                    ...
                    <div className={"page1"}>
                        ...
                        <p className={"description"}>OLEX olarak,araç koruma çözümlerinde mükemmelliği ve güvenilirliği
                            taahhüt
                            ediyoruz.
